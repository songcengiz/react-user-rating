...
export default function App() {
  ...
  return (
    <>
      {isSubmit ? (
        <ResultRating rate={rate} />
      ) : (
        <StarRating rate={rate} setRate={setRate} setIsSubmit={setIsSubmit} />
      )}
    </>
  );
}

function StarRating({ rate, setRate, setIsSubmit }) {
      ...
      <div className="rate-box">
        ...
        <div className="rating">
          {Array.from({ length: 5 }, (_, i) => (
            <button
              className={rate === i + 1 ? "btn-clicked" : "btn-rating"}
        ...
        <button className="btn-add" onClick={() => setIsSubmit(true)}>
          Submit
        </button>
      </div>
    </div>
  ...
  return (
    <div className="app">
      <div className="result-box">
        ...
        <button className="btn-message">{`You selected ${rate} out of 5`}</button>
        <h2>Thank you!</h2>
        <p>
