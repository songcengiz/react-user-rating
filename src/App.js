...
export default function App(params) {
  ...
  return (
    <div>
      {!showMessage ? (
        <EmailForm onAddUser={handleAddUser} />
      ) : (
        <SubscribeMessage userInfo={userInfo} setShowMessage={setShowMessage} />
      )}
    </div>
  );
}

function EmailForm({ onAddUser }) {
      ...
      <div className="app">
        <div className="sign-up-text">
          ...
          <form onSubmit={handleSubmitUser}>
            ...
            <input
              className={!formIsValid ? "input-error" : ""}
              value={email}
              onChange={(e) => {
              ...
              type="email"
              placeholder="son@loremcompany.com"
            />
...
function SubscribeMessage({ userInfo, setShowMessage }) {
    ...
    <div className="message">
      ...
      <div className="message-text">
        ...
        <p>
          ...
          <strong> {userEmail}</strong>. Please open it and click the button
          inside to confirm your subscription.
        </p>
      </div>
      <button className="btn-message" onClick={() => setShowMessage(false)}>
        Dismiss message
      </button>
    </div>
  );
